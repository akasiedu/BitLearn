...
//        }
        ...
        final int color3 = ContextCompat.getColor(this, android.R.color.holo_blue_dark);
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        String[] vprops = new String[]{"Hello", "Kwame", "Asiedu"};
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            textView = (TextView) rootView.findViewById(R.id.valueProp);
            textView.setText(vprops[getArguments().getInt(ARG_SECTION_NUMBER) - 1]);
